...
class WpParallaxContentSlider 
{
	...
	{ 
		...
		wp_enqueue_script( 'wp-parallax-content-slider-modernizr', plugins_url( 'js/modernizr.custom.28468.js', __FILE__ ) );
	...
	{ 
		// - ROADMAP ----------------------------------------------
		// 2012.04.10 - v0.1 > Slider content and number of slides are static, admin page is developped but parameters are not used
		// 2012.04.12 - v0.2 > Use admin parameters to customize the CSS Style and JQuery script and add french translation (.po files)
		// 2012.04.24 - v0.3 > Add selection of last articles to display in a dynamic slider instead of static content
		// 2012.04.25 - v0.4 > Add parameters to increase customization level and add a true static display mode support
		// 2012.05.31 - v0.5 > Add thumbnails display in dynamic mode and a new parameter to declare a default image
		// 2012.07.16 - v0.5.1 > Opera bug fix
		// 2012.07.XX - v0.6 > Add extra parameters to increase customization level (Post category filter, order, sort)
		// 2012.0X.XX - v0.7 > Add extra parameters to increase customization level (themes), add swipe detection for touch screens
						...
						<td>
							<select name="prlx_slider_categories[]" id="prlx_slider_categories" multiple="multiple" size="3" style="vertical-align: top;">
                            	<?php 
                            		...
                            		var_dump($prlx_slider_categories_array);
